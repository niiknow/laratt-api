...
class RequestSearchQuery
{
    ...
    public function __construct(Request $request, $query, $searchables = [])
    {
     ...
     */
    public function export($columns, $fileName, $headings = null)
    {
        ...
        return Excel::download(
            ...
            "$fileName-export-$currentDate.csv"
        );
    }
}
